...
#' Summary for GPUglm objects
#' @param object A GPUglm object
#' @param correlation Logical, if TRUE the correlation matrix of the estimated parameters is returned and printed. Default is FALSE.
#' @param ... Additional arguments
#' @exportS3Method base::summary GPUglm
